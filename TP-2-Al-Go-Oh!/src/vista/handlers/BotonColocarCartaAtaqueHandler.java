...
public class BotonColocarCartaAtaqueHandler implements EventHandler<ActionEvent> {
	...
	public BotonColocarCartaAtaqueHandler(VistaCampoDeBatalla vistaCampo, AlGoOh algooh, TextField texto,ContenedorFasePreparacion contenedor) {
